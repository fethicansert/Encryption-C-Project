...
***Projemiz Devrim Seral hocamin hazirlardai TCP Echo Serveri fonksiyonel bir File Servere donusturmekti bu Programi Linux bir serverde calistrabilirsiniz.
*/
/* C header files */
#include <stdio.h>
#include <stdlib.h>
